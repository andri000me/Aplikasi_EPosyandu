<?php
    ...
    if($op == "ambiloption"){
        ...
        $jk_anak = htmlspecialchars($_GET['jk_anak']);  
        $tambah = mysqli_query($conn, "INSERT INTO ref_anak(id_anak, nama_anak, nik_anak, tempat_lahir_anak, tanggal_lahir_anak, usia, jk_anak) VALUES('$id_anak', '$nama_anak2','$nik_anak','$tempat_lahir_anak','$tgl_lahir_anak', '$usia_anak', '$jk_anak')");
